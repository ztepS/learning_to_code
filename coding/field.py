...
class arrow:
    ...
    def draw(self):
        pygame.draw.aaline(window,(255,255,255),((self.X+5),(self.Y+5)),((self.X+5)+math.cos(self.rotation*3.14/180)*self.strength/10,(self.Y+5)+math.sin(self.rotation*3.14/180)*self.strength/10))
        #print pygame.draw.circle(window,(255, 255, 255),(self.X+5,self.Y+5),5)
        
    def rotate(self,angle,strength):
        if(self.rotation>angle):self.rotation +=strength
        else:self.rotation -=strength
